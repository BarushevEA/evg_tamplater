...
import {E_SUB_ROUTE, TYPE} from "./subRoutesEnums";
...
export const app_sub_route = new APP_SUB_ROUTE(E_SUB_ROUTE.VIEW, TYPE.BUTTON);
app_sub_route
    .addPage(TYPE.BUTTON, View_button)
    .addPage(TYPE.IMAGE, View_image);
