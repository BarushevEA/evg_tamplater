...
export class Main implements OnInit, OnCreate, OnDestroy {
    ...
    child1Chanel: IChanel;
    child2Chanel: IChanel;
    child3Chanel: IChanel;
    child4Chanel: IChanel;
    ...
    private initializeChannels() {
        this.child1Chanel = this.root.getChanel(this.child1);
        this.child2Chanel = this.root.getChanel(this.child2);
        this.child3Chanel = this.root.getChanel(this.child3);
        this.child4Chanel = this.root.getChanel(this.child4);
    }
